...
var SupportedVersions = []string{
	...
	"1.32",
	"1.33",
	// ODP stopgap (not upstream gardener): allow k8s 1.34/1.35 seeds until a
	// provider-hcloud release vendors gardener >= v1.136.0, which supports
	// "1.35" natively. See
	// https://github.com/23technologies/gardener-extension-provider-hcloud/issues/310
	"1.34",
	"1.35",
}
